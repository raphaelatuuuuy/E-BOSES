...
const FOLDER_POCKET = "#2b1d13"
const FOLDER_STROKE = "rgba(198,140,88,0.32)"
const FOLDER_SEAM = "rgba(198,140,88,0.16)"
    ...
    >
      <div className="problem-logbook-inner relative">
        ...
        <svg viewBox="0 0 360 264" className="block h-auto w-full" style={GLOW} fill="none">
          ...
          {/* Tab base seam */}
          <line className="logbook-stroke" x1={40} y1={60} x2={190} y2={60} stroke={FOLDER_SEAM} />
        ...
        <div className="problem-slip-drift absolute left-[9%] top-[32%] w-[38%]">
          <div className="problem-slip -rotate-6 border border-black/10 bg-neutral-50 p-3 shadow-[0_10px_30px_rgba(0,0,0,0.55)]">
            <div className="h-px w-3/4 bg-neutral-900/25" />
            <div className="mt-2 h-px w-full bg-neutral-900/15" />
            <div className="mt-2 h-px w-1/2 bg-neutral-900/15" />
          </div>
        </div>

        <div className="problem-slip-drift absolute right-[6%] top-[24%] w-[50%]">
          <div className="problem-slip rotate-2 border border-primary/35 bg-neutral-50 p-3 shadow-[0_10px_30px_rgba(0,0,0,0.55),0_0_18px_rgba(255,80,3,0.1)]">
            <div className="flex items-center justify-between gap-2">
              <div className="h-px w-1/4 bg-neutral-900/25" />
            ...
            <div className="mt-2.5 h-px w-full bg-neutral-900/15" />
            <div className="mt-2 h-px w-2/3 bg-neutral-900/15" />
          </div>
        </div>

        <div className="problem-slip-drift absolute left-[30%] top-[36%] w-[42%]">
          <div className="problem-slip -rotate-2 border border-black/10 bg-neutral-50 p-3 shadow-[0_10px_30px_rgba(0,0,0,0.55)]">
            <div className="h-px w-2/3 bg-neutral-900/25" />
            <div className="mt-2 h-px w-11/12 bg-neutral-900/15" />
          </div>
        </div>
        ...
        >
          ...
          <rect className="logbook-stroke" x={36} y={196} width={118} height={30} stroke={FOLDER_SEAM} />
          <line className="logbook-stroke" x1={46} y1={208} x2={140} y2={208} stroke="rgba(198,140,88,0.13)" />
          <line className="logbook-stroke" x1={46} y1={216} x2={122} y2={216} stroke="rgba(198,140,88,0.13)" />
        </svg>
      </div>
    </div>
  )
