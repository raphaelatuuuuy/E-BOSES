      ...
      <div className="grid grid-cols-1 gap-x-10 gap-y-14 sm:grid-cols-2 lg:grid-cols-3">
        {HELP_COLLECTIONS.map((collection) => {
          ...
          return (
            ...
            >
              <span className="flex size-20 shrink-0 items-center justify-center rounded-2xl bg-brand-navy text-white transition-[transform,background-color,box-shadow] duration-200 ease-out group-hover:scale-110 group-hover:bg-accent group-hover:shadow-lg motion-reduce:transition-none motion-reduce:group-hover:scale-100">
