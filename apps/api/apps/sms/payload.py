...
class InboundPayload:
    ...
    def dedupe_key(self) -> str:
        ...
        message. Otherwise the sender, the exact text and a 60-second bucket
        stand in — long enough to absorb a retry storm, short enough that a
        resident who genuinely texts ``HELP FIRE`` twice two minutes apart is
        treated as two messages.
        """
