...
export function SummaryBox({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-panel bg-card-raised p-3">
      <p className="text-[10px] font-semibold uppercase text-subtle-foreground">{label}</p>
