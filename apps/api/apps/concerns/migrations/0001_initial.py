...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(model_name="concern", index=models.Index(fields=["status", "created_at"], name="concerns_co_status_1ace51_idx")),
        migrations.AddIndex(model_name="concern", index=models.Index(fields=["ai_severity_score"], name="concerns_co_ai_seve_a2f617_idx")),
    ]
