...
# never shows an unvalidated "—" row. Configurations 178/179 come from a
# lineage that lost civil_status/issue_date, so fields are re-added here too.
MISSING_FIELDS = [
    {
        "code": "civil_status",
        "label": "Civil status",
...
class Migration(migrations.Migration):
    dependencies = [("accounts", "0029_ocr_add_missing_field_rules")]
