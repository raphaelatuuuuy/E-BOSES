...
export const VOCABULARY: Record<string, StatusEntry> = {
  ...
  awaiting_acknowledgment: { residentLabel: "Waiting for the responder", officialLabel: "Awaiting responder", group: "open" },
  acknowledged: { residentLabel: "Responder confirmed", officialLabel: "Responder confirmed", group: "active" },
