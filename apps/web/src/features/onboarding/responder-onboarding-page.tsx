...
const steps = [
  { imgMb: "/contents/responder-onboard-mb-1.png", img: "/contents/responder-onboard-1.png", title: "Respond when your community needs you", description: "Receive assigned emergencies and urgent concerns with the information needed to take action." },
  ...
  { imgMb: "/contents/responder-onboard-mb-3.png", img: "/contents/responder-onboard-3.png", title: "Keep everyone updated", description: "Acknowledge assignments, update your response status, and document the incident until it is resolved." },
]
